...
$method = "NitCliente=".$_POST['NitCliente']."&Empresa=".$_POST['Empresa']."&Anho=".$_POST['Anho']."&FechaInicial=".$_POST['FechaInicial']."&FechaFinal=".$_POST['FechaFinal']."&Estado=".$_POST['Estado']." ";
// abrimos la sesión cURL
$ch = curl_init();
// definimos la URL a la que hacemos la petición
curl_setopt($ch, CURLOPT_URL,"http://www.grupologisnovasoft.com/WsAppMovil/MaestroEmpleados");
